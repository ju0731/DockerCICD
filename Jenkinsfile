...
'''
    ...
    stage('Make Service') {
      steps {
        sh '''aws ecs create-service --cluster obd-docker-cluster-hanju --service-name fargate-service --task-definition sample-fargate1:1 --desired-count 1 --launch-type "FARGATE" --network-configuration "awsvpcConfiguration={subnets=[subnet-0358ae653e4b4a215, 	
